$(function() {
  ...
  var myDropzone = new Dropzone("div#droparea", {
    ...
    thumbnailHeight: 300,
    maxFiles: 3,
    acceptedFiles: "image/png, image/jpeg, image/gif,.psd,.pmx,.pmd,.vrm,tga,png,dds,.bmp,.zip", //This is a comma separated list of mime types or file extensions.Eg.: image/*,application/pdf,.psd.
